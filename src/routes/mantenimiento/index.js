...
import { getDashboardStats, calculateKPIs } from '../../services/dashboardService';
                ...
                <div className={`card ${style.maintenanceAnalysisCard}`}>
                    ...
                    {dashboardData?.vehiculos?.analisis_mantenimiento && dashboardData.vehiculos.analisis_mantenimiento.length > 0 ? (
                        <div className={style.maintenanceAnalysis}>
                            {dashboardData.vehiculos.analisis_mantenimiento.slice(0, 10).map((vehiculo) => (
                            ...
                            <div className={style.statsList}>
                                <div className={style.statItem}>
                                    ...
                                    <div className={style.statBar}>
                                        <div className={style.statProgress} style={{ width: '85%' }} />
                                    </div>
                                </div>
                                <div className={style.statItem}>
                                    ...
                                    <div className={style.statBar}>
                                        <div className={style.statProgress} style={{ width: '76%' }} />
                                    </div>
                                </div>
                                <div className={style.statItem}>
                                    ...
                                    <div className={style.statBar}>
                                        <div className={style.statProgress} style={{ width: '12%', backgroundColor: '#ff6b6b' }} />
                                    </div>
                                </div>
                                <div className={style.statItem}>
                                    ...
                                    <div className={style.statBar}>
                                        <div className={style.statProgress} style={{ width: '92%', backgroundColor: '#51cf66' }} />
                                    </div>
                                </div>
                            </div>
                        </div>
